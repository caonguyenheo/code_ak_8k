...
#define SYS_RECORD_DURATION_TIME            11
...
#define CFG_AUDIO_DURATION              (32) // ms
...
#define CFG_AUDIO_LENGTH_SEND					(256) // 16 packet/second
...
#define CFG_TALKBACK_SAMPLE_RATE           (8000)
...
#define SPI_CMD_RB_LEN                          (256*1024)
...
#define SPI_UPLOADER_BUFFER_LEN                             (128*1024)
#define SPI_P2PSDSTREAM_BUFFER_LEN                          (128*1024)
...
#define SPICMD_TYPE_EN_VOICE_CONNECTED                0x19
...
#define LOCAL_VERSION_STR                 "Tinkle820FM_01.00.74_10uF_8MHz_gop12_agc"
...
#define len_arrding      6986
#define len_arrsuccess   11698
#define len_arrfail      9684
#define len_arrtime      11546

#define len_chsuccess    14244
#define len_chfail       14050
#define len_chtimeout    14828

#define LEN_SORRYNOTFREETOMEETNOW    43930   //21004
#define LEN_YOUCANLEAVEIT            42258  //16800
#define LEN_WElCOMECOMINGOVERNOW     45184  //19946
#define LEN_HOWCANIHELP              24286  //12088
#define LEN_SORRYNOTATHOME           45602  //18966


#define LEN_CH_SORRYNOTFREETOMEETNOW    54294
#define LEN_CH_YOUCANLEAVEIT            49110
#define LEN_CH_WElCOMECOMINGOVERNOW     40470
#define LEN_CH_HOWCANIHELP              26070
#define LEN_CH_SORRYNOTATHOME           51414

#define LEN_EN_CONNECTED                18852
#define LEN_EN_UNABLETOCONNECT          24704
#define LEN_EN_WARNINGWIFIISWEAK        46856
#define LEN_BEEP                        8144
